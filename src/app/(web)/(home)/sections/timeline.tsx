...
export const AboutTimeline = () => {
    ...
    return (
        <section className='mx-auto w-full z-50 my-20'>
            <h1 className="max-md:mb-3 w-full py-3 px-4 backdrop-blur-sm sticky z-50 top-0 max-md:text-3xl text-5xl tracking-tighter font-bold font-sans">
            ...
            <div className="relative max-sm:p-4 sm:pb-12 sm:ml-[calc(2rem+1px)] mt-10 md:ml-[calc(3.5rem+1px)] lg:ml-[max(calc(14.5rem+1px),calc(100%-48rem))]">
